...
export default function AppGuide ()  {
  ...
  return (
    <View style={{ flex: 1, alignItems: "center" }}>
      ...
      >
        <Slide slide={1} editHour={editHour} setEditHour={setEditHour}/>
        <Slide slide={2} editHour={editHour} setEditHour={setEditHour}/>
        <Slide slide={3} editHour={editHour} setEditHour={setEditHour}/>
      </ScrollView>
